...
// The TypeScript interfaces remain the same (as defined in the previous response).
      ...
      "2": [
        {
          ...
          price: "₱5,200",
          sessions: "8 sessions",
          credits: "8", // Matches your exact monthly session count
      ...
      "3": [
        {
          ...
          credits: "12", // Matches your exact monthly session count
          perSession: "₱650/session",
      ...
      "5": [
        {
          ...
          credits: "20", // Matches your exact monthly session count
          perSession: "₱650/session",
